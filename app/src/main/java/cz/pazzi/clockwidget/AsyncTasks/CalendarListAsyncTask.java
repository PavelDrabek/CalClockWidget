...
//        return calendars;
        ...
        return DownloadCalendars(context);
    }
    ...
    public static List<GCalendar> DownloadCalendars(Context context) {
        GoogleProvider gProvider =  GoogleProvider.getInstance(context);
        List<GCalendar> calendars = new ArrayList<>();
        String pageToken = null;
